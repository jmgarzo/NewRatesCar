...
//
///**
// * Created by jmgarzo on 01/12/16.
// */
//
//public class FirstDBLoad extends AsyncTask<RefuelContentValues, Void, Void> {
//
//    private SQLiteDatabase db;
//    private Context context;
//
//    public FirstDBLoad(SQLiteDatabase db, Context context) {
//        this.db = db;
